...
<?php if(mysqli_num_rows($data) > 0): ?>
    ...
    <?php while($t = mysqli_fetch_assoc($data)) : ?>
        ...
        <div class="card <?= $t['is_pinned'] ? 'ring-2 ring-yellow-400 dark:ring-yellow-500' : '' ?>">
            ...
            <div class="flex justify-between items-start">
                ...
                <div class="flex gap-2">
                    ...
                    <button
                        ...
                        class="
                            btnPin
                            <?= $t['is_pinned'] ? 'bg-yellow-400 hover:bg-yellow-500' : 'bg-gray-300 hover:bg-gray-400 dark:bg-slate-600 dark:hover:bg-slate-500' ?>
                            text-white
                            w-10
                            h-10
                            rounded-xl
...
<form
    action="../process/tabungan/tambah.php"
    method="POST"
>
...
<form
    action="../process/tabungan/edit.php"
    method="POST"
>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href =
                    '../process/tabungan/hapus.php?id=' + id;
...
document.querySelectorAll('.btnPin')
.forEach(button => {
