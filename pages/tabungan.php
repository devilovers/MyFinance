                ...
                <div>
                    ...
                    <div class="flex flex-col gap-0.5 mb-5">
                        <div class="text-xs text-slate-400 dark:text-slate-500 flex justify-between items-center">
                            ...
                            <?php if ($sisa_dana > 0): ?>
                                <span class="text-xs font-semibold text-red-500 bg-red-50 dark:bg-red-950/30 px-1.5 py-0.5 rounded">-<?= rupiah($sisa_dana) ?></span>
                            <?php else: ?>
                                <span class="text-xs font-semibold text-emerald-500 bg-emerald-50 dark:bg-emerald-950/30 px-1.5 py-0.5 rounded"><?= $lang['lunas'] ?? 'Lunas'; ?></span>
                            <?php endif; ?>
                        </div>
